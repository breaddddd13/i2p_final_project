...
Attack::Attack( Circle* created_circle, int dgr, int harm_point, int velocity, ALLEGRO_BITMAP* attack_img)
{
...
Attack::Draw()
{
    ...
    pos_x += attack_velocity * cos(degree*rad);
    pos_y += attack_velocity * sin(degree*rad);
